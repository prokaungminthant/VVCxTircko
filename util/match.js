...
<div id="row" class="listHead">
  ...
  <div class="listT">CopyLink</div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/experimental#${reg0Ffa}'">
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/experimental#${reg1Ffa}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/experimental#${reg2Ffa}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/experimental#${reg3Ffa}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/#${reg0Ctg}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/#${reg1Ctg}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/#${reg2Ctg}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/#${reg3Ctg}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/#${reg0Svv}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/#${reg1Svv}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/#${reg2Svv}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
    ...
    <div class="join" onclick="location.href ='https://voxiom.io/#${reg3Svv}'">
        <span class="material-symbols-outlined">
            play_circle
        </span>
    </div>
