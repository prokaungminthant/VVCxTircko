    ...
    const observerCallback = function (mutationsList, observer) {
        for (let mutation of mutationsList) {
            mutation.addedNodes.forEach(addedNode => {
                ...
                } else if (addedNode.className === "sc-cVeCjG gtMOKh" || addedNode.className === "sc-dHxrtn zzmRx" || addedNode.className === "sc-fOfeEA bggwgU" || addedNode.className === "sc-cVeCjG gtMOKh" || addedNode.className === "sc-iSLKLn ctoevy" || addedNode.className === "sc-iSLKLn ctoevy" || addedNode.className === "sc-bJijCA koPVTY" || addedNode.className === "sc-djoyIk efIxmv" || addedNode.className === "sc-jjBTab cPzpQf" || addedNode.className === "sc-mDocm jcrddu" || addedNode.className === "sc-fZjiHd kgHOae" || addedNode.className === "sc-cCcXHH eoXzlP") {
                    tools.initTitleText()
                    tools.menuBarAddition()
